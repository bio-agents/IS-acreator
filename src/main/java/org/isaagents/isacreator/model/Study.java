...
public class Study extends ISASection {
    ...
    /**
     * Add a Contact (@see org.isaagents.isacreator.model.Contact) to this Study
     *
    ...
    /**
     * Add a Publication (@see org.isaagents.isacreator.model.Publication) to the Study
     *
    ...
    /**
     * Add a Factor (@see org.isaagents.isacreator.model.Factor) to the Study
     *
    ...
    /**
     * Add a Protocol (@see org.isaagents.isacreator.model.Protocol) to the Study
     *
