...
public class Assay extends ISASection implements StudySubData {
     ...
     * @param tableReferenceObject - the Table Reference Object which contains all the properties of a an Assay, in particular defining which Columns are required, Which are Ontology terms, etc. These files are provided via the ISAConfiguration Agent.
     */
