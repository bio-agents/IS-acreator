            ...
            public void run() {
                ...
                if (ISAcreatorCLArgs.username()!=null && ISAcreatorCLArgs.password()!=null){
                    ...
                    if (loggedIn){
                        ...
                        //not logged in
                        main.createGUI(ISAcreatorCLArgs.configDir(), ISAcreatorCLArgs.username(), null, ISAcreatorCLArgs.isatabDir(), null, gsAuthentication, "org.isaagents.isacreator.gs.gui.GSAuthenticationMenu", false);
