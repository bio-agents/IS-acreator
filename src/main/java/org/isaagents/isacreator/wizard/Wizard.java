...
import org.isaagents.isacreator.gui.*;
import org.isaagents.isacreator.gui.formelements.AssaySubForm;
import org.isaagents.isacreator.gui.formelements.FactorSubForm;
...
public class Wizard extends AbstractDataEntryEnvironment {
    ...
    private JPanel createAssayFactorsAndGroupsPanel() {
        ...
        organism.setAgentTipText(
                "<html><b>Organism</b><p>Please select the organism the study is based on using the ontology selection agent!</p></html>");
        ...
        numTreatmentGroups.setAgentTipText(
        ...
        numSamplesPerGroup.setAgentTipText(
    ...
    private JPanel createStudyDetailsPanel() {
        ...
        studyDescription.setAgentTipText(
