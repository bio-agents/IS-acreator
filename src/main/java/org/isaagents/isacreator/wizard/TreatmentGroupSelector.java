...
public class TreatmentGroupSelector extends JPanel {
    ...
    class TreatmentGroupInformation extends JPanel {
        ...
        private void instantiatePanel() {
            ...
            numReplicates.setAgentTipText("<html><b>Number of replicates</b><p>The number of replicates performed on this factor group</p></html>");
...
//			useGroup.setPreferredSize(new Dimension(400, 25));
            ...
            useGroup.setAgentTipText("<html><b>Use this factor group</b><p>Is this factor group used in the study?</p></html>");
