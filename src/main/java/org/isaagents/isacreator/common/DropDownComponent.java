...
import org.isaagents.isacreator.ontologyselectionagent.OntologySelector;
 ...
 * and OntologySelectionAgent to be displayed.
 *
...
public class DropDownComponent extends JComponent implements ActionListener,
    ...
    private void createIcon(final Window container, final int type) {
        ...
        icon.setAgentTipText(type == CALENDAR ? "<html>select <b>date</b> from a calendar utility</html>" :
