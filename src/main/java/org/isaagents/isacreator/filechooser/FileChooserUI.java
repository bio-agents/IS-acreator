...
public class FileChooserUI extends AnimatableJFrame implements WindowListener {
    ...
    private JPanel createTopPanel() {
        ...
        connectLab.setAgentTipText("<html><b>Connect</b><p>Connect to the FTP source defined!</p></html>");
        ...
        historyLab.setAgentTipText("<html><b>Search previously connected to FTP locations</b><p>Connect to a previously defined FTP location</p></html>");
    ...
    /**
     * Creates the FileSelection panel containing the list of selected files, and the agentbar to modify the list
     *
    ...
    private JPanel createFilesSelectedPanel() {
        ...
        // add list modification agentbar to sort, move, and delete files from the list.
