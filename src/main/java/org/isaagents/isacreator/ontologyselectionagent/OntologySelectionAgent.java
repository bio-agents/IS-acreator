...
import org.isaagents.isacreator.common.filterableTree.FilterableJTree;
import org.isaagents.isacreator.common.filterableTree.TreeFilterModel;
import org.isaagents.isacreator.configuration.OntologyBranch;
...
import org.isaagents.isacreator.effects.SingleSelectionListCellRenderer;
import org.isaagents.isacreator.ontologybrowsingutils.OntologyTreeItem;
import org.isaagents.isacreator.ontologybrowsingutils.WSOntologyTreeCreator;
import org.isaagents.isacreator.ontologymanager.*;
import org.isaagents.isacreator.ontologymanager.bioportal.model.OntologyPortal;
...
import org.isaagents.isacreator.optionselector.OptionGroup;
...
/**
 * OntologySelectionAgent provides interface to connect to the OLS (OR bioPortal) to retrieve appropriate
 ...
 */
public class OntologySelectionAgent extends JFrame implements MouseListener, OntologySelector, WindowListener {

    private static final Logger log = Logger.getLogger(OntologySelectionAgent.class.getName());
     ...
     *
     */
    public OntologySelectionAgent() {
        this(false, false, new HashMap<String, RecommendedOntology>());
    }

    /**
     * OntologySelectionAgent constructor.
     *
     ...
     */
    public OntologySelectionAgent(boolean multipleTermsAllowed, boolean forceOntologySelection, Map<String, RecommendedOntology> recommendedOntologies) {
    ...
    /**
     * Create the OntologySelectionAgent GUI.
     */
    public void createGUI() {

        setTitle("Ontology Selection Agent");
    ...
    private void createSearchUI(boolean recommendedOntologiesAvailable) {
        ...
        searchOntologiesButton.setAgentTipText("<html><b>search</b> for term</html>");
    ...
    private void createHistoryPanel() {
        ...
        historyList.setAgentTipText("click on term to select it...");
            ...
            public void run() {
                if (!searchField.getText().equals("")) {
                    try {
                        ...
                        OntologySelectionAgent.this.validate();
