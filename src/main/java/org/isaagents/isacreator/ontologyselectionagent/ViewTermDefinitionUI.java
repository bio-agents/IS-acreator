...
public class ViewTermDefinitionUI extends JPanel {
    ...
    private static final ImageIcon LOADING = new ImageIcon(ViewTermDefinitionUI.class.getResource("/images/ontologyselectionagent/loading.gif"));
    ...
    private JEditorPane createOntologyInformationDisplay(OntologyBranch term) {
        ...
        if (properties != null && properties.size() > 0) {
            ...
            labelContent += "<p>No definition found for this term! This can be due to 2 reasons: " +
                    ...
                    "ability to view the definitions for a term in this agent is not yet fully supported.</p>";
        }
