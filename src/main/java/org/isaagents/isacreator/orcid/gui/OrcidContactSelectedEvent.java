...
public class OrcidContactSelectedEvent implements PropertyChangeListener {
    ...
    public OrcidContactSelectedEvent(OrcidLookupUI ontologySelectionAgent,  JTextField orcid, JTextField fn, JTextField ln, JTextField e) {
        this.orcidLookupUI = ontologySelectionAgent;
