...
package org.isaagents.isacreator.longtexteditor;
...
public class TextEditingComponent extends JPanel implements DocumentListener {
    ...
    public TextEditingComponent() {
        ...
        system = Agentkit.getDefaultAgentkit().getSystemClipboard();
    ...
    public JPanel createAgentBar() {
        JPanel agentbar = new JPanel();
        agentbar.setLayout(new BoxLayout(agentbar, BoxLayout.PAGE_AXIS));
        agentbar.setBackground(UIHelper.BG_COLOR);
