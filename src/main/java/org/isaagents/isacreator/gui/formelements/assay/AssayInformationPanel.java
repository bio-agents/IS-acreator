package org.isaagents.isacreator.gui.formelements.assay;
...
public class AssayInformationPanel extends JPanel {
    ...
    private Container createTopSection() {
        ...
        closeButton.setAgentTipText("<html>Delete this assay</html>");
        ...
        viewButton.setAgentTipText("<html>View this assay</html>");
