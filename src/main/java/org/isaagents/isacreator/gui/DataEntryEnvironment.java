...
import org.isaagents.isacreator.gui.help.Controller;
...
import org.isaagents.isacreator.utils.datastructures.CollectionUtils;
...
/**
 * org.isaagents.isacreator.gui.DataEntryEnvironment class contains all the fields required for entry of experimental information
...
public class DataEntryEnvironment extends AbstractDataEntryEnvironment implements
     ...
     * @param type     - Either org.isaagents.isacreator.gui.Study or org.isaagents.isacreator.gui.Assay
    ...
    private JPanel createNavPanel(Investigation investigation) {
        ...
        overviewTree.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (path != null) {
                    overviewTree.setAgentTipText(path.getLastPathComponent().toString());
                }
            }
        });
        ...
        addStudyButton.setAgentTipText("<html>Add a new Study</html>");
        ...
        removeStudyButton.setAgentTipText("<html>Remove the selected study</html>");
        ...
        visualization.setAgentTipText("<html>Visualize the submission</html>");
                ...
                expViz.addPropertyChangeListener("reducedFunctionality", new PropertyChangeListener() {
                    public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
                        ...
                        JOptionPane optionPane = new JOptionPane("<html><b>Reduced functionality enforced</b>" +
                                ...
                                "<p>The next release of <b>ISAcreator</b> will contain new ways to visualize data which don't impact on the agents performance!</html>",
