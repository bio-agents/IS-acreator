package org.isaagents.isacreator.validateconvert.ui;
...
import org.isaagents.isacreator.effects.SimpleListCellRenderer;
import org.isaagents.isacreator.launch.ISAcreatorGUIProperties;
...
import org.isaagents.isacreator.validateconvert.ui.ENAReceipt.ENAReceipt;
import org.isaagents.isacreator.validateconvert.ui.ENAReceipt.ENAReceiptParser;
import org.isaagents.isatab.export.sra.submission.ENAResponse;
import org.isaagents.isatab.export.sra.submission.ENARestServer;
import org.isaagents.isatab.export.sra.submission.SRASubmitter;
import org.isaagents.isatab.gui_invokers.AllowedConversions;
import org.isaagents.isatab.gui_invokers.GUIISATABValidator;
import org.isaagents.isatab.gui_invokers.GUIInvokerResult;
...
//        metadataSection.add(Box.createVerticalGlue());
    ...
    private Container createSubmitComplete(ENAReceipt receipt) {
        ...
        studies.setAgentTipText("ENA accession numbers for the submitted studies");
        ...
        experiments.setAgentTipText("ENA accession numbers for the submitted experiments");
        ...
        runs.setAgentTipText("ENA accession numbers for the submitted runs");
        ...
        samples.setAgentTipText("ENA accession numbers for the submitted samples");
