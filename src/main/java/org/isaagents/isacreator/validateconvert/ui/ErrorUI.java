...
public class ErrorUI extends Container {
    ...
    public void constructErrorPane(List<ErrorMessage> errorMessages, String action) {
        ...
        messagePane.setBackground(org.isaagents.errorreporter.ui.utils.UIHelper.BG_COLOR);
        messagePane.setSelectionColor(org.isaagents.errorreporter.ui.utils.UIHelper.LIGHT_GREEN_COLOR);
        messagePane.setSelectedTextColor(org.isaagents.errorreporter.ui.utils.UIHelper.BG_COLOR);
